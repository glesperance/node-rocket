...
exports.setup = function setup_client() {
   ...
   * as `/static`
   */
  app.use('/static', gzip.staticGzip(static_dir_path));
                ...
                [ function (callback) { 
                    async.waterfall(
                        ...
                        , function(callback) {
                            ...
                            //as `/js`
                            app.use('/js', gzip.staticGzip(client_build_js_dir_path));
                ...
                , function (callback) { 
                    async.waterfall(
                        ...
                        , function(callback) {
                            ...
                            //as `/css`
                            app.use('/css', gzip.staticGzip(client_build_css_dir_path));
