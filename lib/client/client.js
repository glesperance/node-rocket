 ...
 */
function compileViews(src_path, dst_path, callback) {
  ...
  async.waterfall( 
            ...
            , function iterator(filename, callback) {
                ...
                if (filename === REQUIRE_JS_CONFIG_FILE_NAME) {
                  ...
                  async.waterfall(
                      ...
                      , function(callback) { compileViews(module_path, symlink_path, true, callback); }
                      ]
                    , callback
                  );
      ...
      , function(callback) {
          ...
          if (views) {
            ...
            fs.symlink(path.join(__dirname, 'vendors', JADE_RUNTIME_FILE_NAME), tmp_jade_runtime_path, callback);
