...
function exportConfig(config_file_path, callback) {
...
exports.setup = function setup_client() {
   ...
   * as `/rocket-js`
   */
  app.use('/rocket-js', express.static(path.join(__dirname, 'rocket-js')));
  ...
  if (process.env['NODE_ENV'] === 'production') {
    ...
    async.parallel([
      ...
      , async.apply(exportConfig, require_js_config_path)
    ...
    exportConfig(require_js_config_path, callback);
