...
var rocket_tmpl         = {};
    ...
    rocket_tmpl.footer  = function() {
      return [
              ...
              , "  Modernizr.load(["
              , "      {"
              , "          load      : '//cdnjs.cloudflare.com/ajax/libs/require.js/0.26.0/require.min.js'"
              , "        , callback  : function() {"
              , "             window.require || document.write('<script src=\"/js/rocket/vendors/require-0.27.0.min.js\"><\\/script>')"
              , "          }"
              , "      }"
              , "  ]);"
              , "</script>"
