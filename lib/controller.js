...
var express             = require('express')
  , express-resource    = require('express-resource')
  , async               = require('async')
  , path                = require('path')
...
var rocket_tmpl         = {}
  ...
  , rocket_tmpl.header  = function() {
      return [
             ...
             , "script window.Modernizr || document.write('<script src=\"/rocket/vendors/modernizr-2.0.6.min.js\"><\\/script>')"
             ].join('\n');
    }
  ...
  , rocket_tmpl.footer  = function() {
      return [
              ...
              , "     , callback  : function() {"
              , "         window.require || document.write('<script src=\"/rocket/vendors/require-0.24.0.min.js\"><\\/script>')"
              , (global.require_configuration ? "require(" + global.require_configuration + ")" : "")
              , "   });"
              ].join('\n')
     }
  ...
  return function(req, res, next) {
    ...
    if (!req.xhr && view_file) {
      ...
      res.send = function(obj) {
        ...
        obj.rocket = obj.rocket || rocket_template_namespace;
...
exports.setup = function setup_controller() {
 ...
 app.use('/rocket-js', express.static(static_dir_path));
